...
import { Search, ShieldAlert, ClipboardCheck, BriefcaseBusiness, FileClock, Inbox, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 shadow-sm" title="Client ID or verification required">
        ...
        <div className="rounded-2xl border border-indigo-200 bg-indigo-50 p-5 shadow-sm" title="Under your review; Testamentary Capacity can be completed">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 px-5 py-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-xl font-bold text-slate-900">Your matters</h1>
          ...
          <table className="min-w-full divide-y divide-slate-200">
            ...
            <tbody className="divide-y divide-slate-100 bg-white">
              {loading ? (
                ...
                <tr>
                  <td className="px-5 py-8 text-center text-sm text-slate-600" colSpan={6}>
                    No matters match the current filters. Try clearing search or changing status filter.
                  </td>
                </tr>
              ) : matters.map((matter) => (
