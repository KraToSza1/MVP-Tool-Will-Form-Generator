...
export default function QuestionnaireEditorPage() {
  const { formData, refresh } = useFormDefinition();
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button type="button" onClick={handleResetToDefault} className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Reset to default
            </button>
            <button type="button" onClick={handleSaveQuestionnaire} className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700">
              <Save size={16} />
              Save questionnaire
            </button>
          </div>
        ...
        <div className="mt-6">
          ...
          <input
            ...
            onChange={(e) => setDefinition((d) => ({ ...d, formTitle: e.target.value }))}
            className="mt-1 max-w-md rounded-xl border border-slate-300 px-3 py-2 text-sm"
            ...
            <div key={sIdx} className="questionnaire-editor-section rounded-xl border border-amber-200/80 bg-amber-50/40">
              <div className="flex w-full items-center justify-between gap-2 px-4 py-3">
                ...
                <button
                  ...
                  className="questionnaire-edit-section-btn shrink-0 inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium text-amber-800 hover:bg-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-1"
                >
                  <Edit3 size={12} />
                  Edit section
                </button>
